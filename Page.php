...
<div class="d-flex">
        ...
        <div class="col-8  flex-grow-1" style="background-color:#555; color:white; text-align:center;">
            <h1>PotPot Enterprise</h1>
            <p style="font-size:20px;">The shopping spree gods</p>
        </div>
